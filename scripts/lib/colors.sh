...
# BACKGROUND COLORS
#-------------------------------------------------------------------------------
export BG_COLOR_BLACK='\033[40;XXm'
export BG_COLOR_RED='\033[41;XXm'
export BG_COLOR_GREEN='\033[42;XXm'
export BG_COLOR_BROWN='\033[43;XXm'
export BG_COLOR_YELLOW=$BG_COLOR_BROWN
export BG_COLOR_BLUE='\033[44;XXm'
export BG_COLOR_PURPLE='\033[45;XXm'
export BG_COLOR_VIOLET=$BG_COLOR_PURPLE
export BG_COLOR_CYAN='\033[46;XXm'
export BG_COLOR_TURQUOISE=$BG_COLOR_CYAN
export BG_COLOR_GRAY='\033[47;XXm'
export BG_COLOR_RESET='\033[XXm'
...
function unsource_colors {
    ...
    unset BG_COLOR_BLUE
    unset BG_COLOR_PURPLE
    unset BG_COLOR_VIOLET
    unset BG_COLOR_CYAN
    unset BG_COLOR_TURQUOISE
